...
- Beyond Design card stickers (`assets/sticker-*.svg`) — camera, popcorn, record-player,
  tea and lettering stickers from [Flaticon](https://www.flaticon.com/) free sticker packs
  (authors incl. **frdmn**).
